...
Among the covariates, sex_01 refers to the subjects' sex, ethin_ewb refers to their race, T1Income_to_Need referes to the income-to-need ratio or socioeconomic status, IQ refers to intelligence quotient, T1_ACES_sum refers to adverse life events at the initial wave, and first_MDDBP refers to the presence of a first degree relative with a mood disorder.

# Test for MCAR
We need to test whether our data are Missing Completely at Random to justify use of FIML.
```{r MCAR test, cache=TRUE, eval=F}
apply(peer_wide[,c("PPeer_1","TPeer_1","PPeer_3","TPeer_3",
                   "PPeer_5","TPeer_5","PPeer_10","TPeer_10",
                   "PPeer_12","TPeer_12","PPeer_14","TPeer_14")], 2, function(x) sum(!is.na(x)))
apply(peer_wide[,c("PSw_1","TSw_1","PSw_3","TSw_3",
                   "PSw_5","TSw_5","PSw_10","TSw_10",
                   "PSw_12","TSw_12","PSw_14","TSw_14")], 2, function(x) sum(!is.na(x)))
apply(peer_wide[,c("PAgg_1","TAgg_1","PAgg_3","TAgg_3",
                   "PAgg_5","TAgg_5","PAgg_10","TAgg_10",
                   "PAgg_12","TAgg_12","PAgg_14","TAgg_14")], 2, function(x) sum(!is.na(x)))
apply(peer_wide[,c("PPro_1","TPro_1","PPro_3","TPro_3",
                   "PPro_5","TPro_5","PPro_10","TPro_10",
                   "PPro_12","TPro_12","PPro_14","TPro_14")], 2, function(x) sum(!is.na(x)))

MCAR_results <- as.data.frame(matrix(ncol=2, nrow=12))
colnames(MCAR_results) <- c("Model","p")

# MCAR tests by model
MCAR_results[,1] <- c("Peer_MDD","Sw_MDD","Agg_MDD","Pro_MDD",
                      "Peer_INTL","Sw_INTL","Agg_INTL","Pro_INTL",
                      "Peer_EXTL","Sw_EXTL","Agg_EXTL","Pro_EXTL")
MCAR_results[,2] <- c(mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,8:19,115:120)],
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,24:35,115:120)], 
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,40:51,115:120)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,56:67,115:120)], 
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,8:19,96:101)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,24:35,96:101)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,40:51,96:101)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,56:67,96:101)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,8:19,104:109)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,24:35,104:109)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,40:51,104:109)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality),
mean(TestMCARNormality(data_wide[,c(112,3,5:7,123,56:67,104:109)],  
                  imputation.number=200, imputation.method="Normal", seed=50)$pnormality))
```

# Bivariate growth curve models
First we ran bivariate latent growth curves assessing the cross sectional and longitudinal relationships between four types of peer relations (peer victimization, peer-directed aggression, social withdrawal, and prosocial behavior) and three psychopathology symptom dimensions (depression, anxiety, externalizing).
...
#Covariates
iPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
iPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iINTL ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sINTL ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
iPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sPeer ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iEXTL ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sEXTL ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
#Covariates
iAgg ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sAgg ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
#Covariates
iSw ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sSw ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
#Covariates
iPro ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sPro ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
iMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
sMDD ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
'
...
# Bivariate latent change score models (BLCSM)
Next we ran bivariate latent change score models testing the leading/lagging relationship between different types of peer relations and psychopathology dimensions.
5 main models:
...
#Covariates
Peer1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP

MDD1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
INTL1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
EXTL1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Covariates
Agg1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Estimate coupling parameter
dMDD1~4.117*Agg1         # This estimates the Agg to MDD coupling parameter
dMDD2~5.451*Agg2
dMDD3~16.677*Agg3
dMDD4~12.492*Agg4
dMDD5~26.140*Agg5

dAgg1~0.041*MDD1         # This estimates the MDD to Agg coupling parameter
dAgg2~0.034*MDD2
dAgg3~0.031*MDD3
dAgg4~0.031*MDD4
dAgg5~0.028*MDD5
...
#Covariates
Sw1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Estimate coupling parameter
dMDD1~-3.995*Sw1         # This estimates the Sw to MDD coupling parameter
dMDD2~4.234*Sw2
dMDD3~-0.515*Sw3
dMDD4~1.997*Sw4
dMDD5~2.550*Sw5

dSw1~0.015*MDD1         # This estimates the MDD to Sw coupling parameter
dSw2~0.022*MDD2
dSw3~0.008*MDD3
dSw4~0.016*MDD4
dSw5~0.016*MDD5
...
#Covariates
Pro1 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro2 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro3 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro4 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro5 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro6 ~ sex_01 + ethin_ewb + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
fitstats_Pro_INTL[,2:11] <- apply(fitstats_Pro_INTL[,2:11], 2, as.numeric)
...
# Make table of parameters
# Select only the necessary parameters, removing the 'label', 'se', and 'z' columns
out_Pro_INTL_B <- parameterEstimates(fit_Pro_INTL_B, standardized=T)[c(129:148,155:158,165:168,169:174),] %>%
  select(-label,-se,-z) %>%
    mutate(est = if_else(pvalue<.01, paste0(round(est,3),"**"), if_else(pvalue<.05, paste0(round(est,3),"*"), paste0(round(est,3)))))
rownames(out_Pro_INTL_B) <- seq(length=nrow(out_Pro_INTL_B))

out_Pro_INTL_IS <- parameterEstimates(fit_Pro_INTL_IS, standardized=T)[c(129:148,155:158,165:168,169:174),] %>%
  select(-label,-se,-z) %>%
    mutate(est = if_else(pvalue<.01, paste0(round(est,3),"**"), if_else(pvalue<.05, paste0(round(est,3),"*"), paste0(round(est,3)))))
rownames(out_Pro_INTL_IS) <- seq(length=nrow(out_Pro_INTL_IS))

out_Pro_INTL_IR <- parameterEstimates(fit_Pro_INTL_IR, standardized=T)[c(129:148,155:158,165:168,169:174),] %>%
  select(-label,-se,-z) %>%
    mutate(est = if_else(pvalue<.01, paste0(round(est,3),"**"), if_else(pvalue<.05, paste0(round(est,3),"*"), paste0(round(est,3)))))
rownames(out_Pro_INTL_IR) <- seq(length=nrow(out_Pro_INTL_IR))

out_Pro_INTL_T <- parameterEstimates(fit_Pro_INTL_T, standardized=T)[c(129:148,155:158,165:168,169:174),] %>%
  select(-label,-se,-z) %>%
    mutate(est = if_else(pvalue<.01, paste0(round(est,3),"**"), if_else(pvalue<.05, paste0(round(est,3),"*"), paste0(round(est,3)))))
rownames(out_Pro_INTL_T) <- seq(length=nrow(out_Pro_INTL_T))

out_Pro_INTL <- parameterEstimates(fit_Pro_INTL, standardized=T)[c(129:148,155:158,165:168,169:174),] %>%
  select(-se,-z) %>%
    mutate(est = round(est,3))
...
kable(fitstats_Pro_INTL, digits=3,
                        align=c('l',rep('c', 10)),
                        col.names=c(" ", rep(c("Pro","INTL"), times=5)))
```