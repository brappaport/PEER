...
#Covariates
Peer1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Peer6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP

MDD1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
MDD6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
INTL1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
INTL6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
EXTL1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
EXTL6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Covariates
Agg1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Agg6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Covariates
Sw1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Sw6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
#Covariates
Pro1 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro2 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro3 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro4 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro5 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
Pro6 ~ sex + ethin + T1Income_to_Need + IQ + T1_ACES_sum + first_MDDBP
...
fitstats_Peer_MDD[,2:11] <- apply(fitstats_Peer_MDD[,2:11], 2, as.numeric) #FIX THIS
...
##Extra
```{r Extra, echo=TRUE, results = 'asis'}
...
# lavTestLRT(fit_Agg_MDD_B,fit_Agg_MDD_IS)
# lavTestLRT(fit_Agg_MDD_B,fit_Agg_MDD_IR)
# lavTestLRT(fit_Agg_MDD_B,fit_Agg_MDD_T)
# lavTestLRT(fit_Agg_MDD_B,fit_Agg_MDD)
# 
# lavTestLRT(fit_Agg_INTL_B,fit_Agg_INTL_IS)
# lavTestLRT(fit_Agg_INTL_B,fit_Agg_INTL_IR)
# lavTestLRT(fit_Agg_INTL_B,fit_Agg_INTL_T)
# lavTestLRT(fit_Agg_INTL_B,fit_Agg_INTL)
# 
# lavTestLRT(fit_Agg_EXTL_B,fit_Agg_EXTL_IS)
# lavTestLRT(fit_Agg_EXTL_B,fit_Agg_EXTL_IR)
# lavTestLRT(fit_Agg_EXTL_B,fit_Agg_EXTL_T)
# lavTestLRT(fit_Agg_EXTL_B,fit_Agg_EXTL)
# 
# lavTestLRT(fit_Agg_EXTL_IS,fit_Agg_EXTL)
# lavTestLRT(fit_Agg_EXTL_IR,fit_Agg_EXTL)
# lavTestLRT(fit_Agg_EXTL_T,fit_Agg_EXTL)
# 
# lavTestLRT(fit_Sw_MDD_B,fit_Sw_MDD_IS)
# lavTestLRT(fit_Sw_MDD_B,fit_Sw_MDD_IR)
# lavTestLRT(fit_Sw_MDD_B,fit_Sw_MDD_T)
# lavTestLRT(fit_Sw_MDD_B,fit_Sw_MDD)
# 
# lavTestLRT(fit_Sw_INTL_B,fit_Sw_INTL_IS)
# lavTestLRT(fit_Sw_INTL_B,fit_Sw_INTL_IR)
# lavTestLRT(fit_Sw_INTL_B,fit_Sw_INTL_T)
# lavTestLRT(fit_Sw_INTL_B,fit_Sw_INTL)
# 
# lavTestLRT(fit_Sw_INTL_IS,fit_Sw_INTL_IR)
# lavTestLRT(fit_Sw_INTL_T,fit_Sw_INTL_IR)
# lavTestLRT(fit_Sw_INTL,fit_Sw_INTL_IR)
# 
# lavTestLRT(fit_Sw_EXTL_B,fit_Sw_EXTL_IS)
# lavTestLRT(fit_Sw_EXTL_B,fit_Sw_EXTL_IR)
# lavTestLRT(fit_Sw_EXTL_B,fit_Sw_EXTL_T)
# lavTestLRT(fit_Sw_EXTL_B,fit_Sw_EXTL)
# 
# lavTestLRT(fit_Pro_MDD_B,fit_Pro_MDD_IS)
# lavTestLRT(fit_Pro_MDD_B,fit_Pro_MDD_IR)
# lavTestLRT(fit_Pro_MDD_B,fit_Pro_MDD_T)
# lavTestLRT(fit_Pro_MDD_B,fit_Pro_MDD)
# 
# lavTestLRT(fit_Pro_INTL_B,fit_Pro_INTL_IS)
# lavTestLRT(fit_Pro_INTL_B,fit_Pro_INTL_IR)
# lavTestLRT(fit_Pro_INTL_B,fit_Pro_INTL_T)
# lavTestLRT(fit_Pro_INTL_B,fit_Pro_INTL)
# 
...
# 
# lavTestLRT(fit_Pro_EXTL_B,fit_Pro_EXTL_IS)
# lavTestLRT(fit_Pro_EXTL_B,fit_Pro_EXTL_IR)
# lavTestLRT(fit_Pro_EXTL_B,fit_Pro_EXTL_T)
# lavTestLRT(fit_Pro_EXTL_B,fit_Pro_EXTL)
# 
